...
```{r}
data1 <- read_bulk(directory = "~/B.Sc. Cognitive Science/3. semester/Methods 3 - Multilevel Statistical Modeling and Machine Learning/Class/github_methods_3/week_03/experiment_2")
```
