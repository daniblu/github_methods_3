...
sigma(m2)
sigma(m3)
sigma(m4) # eventuelt tibble (hvad er m1 osv.?)
...
qqnorm(resid(m1))
qqline(resid(m1))
title("Old Single Level (m1)", line = 3) # title doesn't show up
...
politeness_na_removed <- politeness %>% # eventuelt fjern na'er helt i starten
  na.omit()
...
```{r 3.2}
#model residuals # variable names not needed
